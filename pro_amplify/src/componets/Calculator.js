...
import { listMetroSts } from '../graphql/queries';

import Paytmblink from './Paytmblink'
...
function Calculator() {
    ...
    const fetchStations = async () => {
        try {
            const stationData = await API.graphql(graphqlOperation(listMetroSts));
            const stationList = stationData.data.listMetroSts.items;
